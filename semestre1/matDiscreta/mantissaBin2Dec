...
# Se não houver nada dentro da lista de numeros antes da virgula, ele adiciona um '0'. É só para visualização. "Efeite".
if len(binListPos) == 0:
  binListPos.append(0)
...
#Descomente a linha abaixo para poder usar este arquivo no cmd:
#input()
